# FeatBit Chart v0.9.11 / App v5.4.1 Migration Guide

## Overview

This release updates FeatBit to version **5.4.1**. It includes **breaking database schema changes** (new indexes and a column type widening) and must be migrated before upgrading an existing deployment.

## Release Information

- **Chart Version**: 0.9.11 (from 0.9.10)
- **FeatBit App Version**: 5.4.1 (from 5.4.0)
- **Release Notes**: https://github.com/featbit/featbit/releases/tag/5.4.1
...
Database migrations cannot be auto-rolled back. The new indexes and column widening are forward-compatible with 5.4.0 (5.4.0 will tolerate the wider column and extra indexes), but if a full revert is required, drop the new indexes and narrow the column manually:
